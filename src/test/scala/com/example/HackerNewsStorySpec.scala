...
class HackerNewsStorySpec extends AnyFlatSpecLike with Matchers with OptionValues{
  ...
  "A case class instance" should "be created successfully" in {
    ...
    val hackerNewsStory = HackerNewsStory(by, descendants, id, kids, score, time, title, `type`, url.some)
    hackerNewsStory should have (
      Symbol("title") (title.value),
    )
    hackerNewsStory.url.value shouldBe url

    import io.circe.refined._
    import eu.timepit.refined.auto._
    import io.circe.generic.auto._, io.circe.syntax._
    hackerNewsStory.asJson.noSpaces shouldBe
    """{"by":"dhouston","descendants":71,"id":8863,"kids":[8952,9224,8917,8884],"score":111,"time":1175714200,"title":"My YC app: Dropbox - Throw away your USB drive","type":"story","url":"http://www.getdropbox.com/u/2/screencast.html","text":null}"""
  }
